export declare const createPlaylist: () => void;
export declare const getPlaylists: () => void;
export declare const getPlaylistById: () => void;
export declare const updatePlaylist: () => void;
